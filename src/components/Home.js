...
function Home () {
    ...
    return(
        <div className='background'   >
            <Cloud/>
          <h1>About Me</h1>
            <p class="introduction">I'm a self-taught programmer and love to build things with emerging web technologies. Although I'm aiming for a front-end position I also study the backend so 
